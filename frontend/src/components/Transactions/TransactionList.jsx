...
const TransactionList = () => {
  ...
  const handleCancel = () => {
    ...
    setIsEditing(false); // Set isEditing to false to hide the form
    setIdentity(""); // Optionally reset selected transaction ID
  };
    ...
    <div className="my-4 p-4 shadow-lg rounded-lg bg-white">
      {isEditing && (
        <TransactionForm
          id = {identity}
          isEditing={true}
          handleCancel={handleCancel} // To handle cancel
        />
      )}
